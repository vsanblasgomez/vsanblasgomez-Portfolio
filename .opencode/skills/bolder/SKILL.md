...
This is a pinned shortcut for `{{command_prefix}}impeccable bolder`.

Invoke {{command_prefix}}impeccable bolder, passing along any arguments provided here, and follow its instructions.
