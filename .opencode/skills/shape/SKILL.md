...
This is a pinned shortcut for `{{command_prefix}}impeccable shape`.

Invoke {{command_prefix}}impeccable shape, passing along any arguments provided here, and follow its instructions.
