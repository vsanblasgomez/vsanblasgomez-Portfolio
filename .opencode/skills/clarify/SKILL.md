...
This is a pinned shortcut for `{{command_prefix}}impeccable clarify`.

Invoke {{command_prefix}}impeccable clarify, passing along any arguments provided here, and follow its instructions.
