...
This is a pinned shortcut for `{{command_prefix}}impeccable init`.

Invoke {{command_prefix}}impeccable init, passing along any arguments provided here, and follow its instructions.
