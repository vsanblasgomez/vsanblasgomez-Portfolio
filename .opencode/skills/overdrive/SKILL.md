...
This is a pinned shortcut for `{{command_prefix}}impeccable overdrive`.

Invoke {{command_prefix}}impeccable overdrive, passing along any arguments provided here, and follow its instructions.
