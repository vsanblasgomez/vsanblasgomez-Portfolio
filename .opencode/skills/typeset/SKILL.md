...
This is a pinned shortcut for `{{command_prefix}}impeccable typeset`.

Invoke {{command_prefix}}impeccable typeset, passing along any arguments provided here, and follow its instructions.
