...
This is a pinned shortcut for `{{command_prefix}}impeccable extract`.

Invoke {{command_prefix}}impeccable extract, passing along any arguments provided here, and follow its instructions.
