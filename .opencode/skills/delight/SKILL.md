...
This is a pinned shortcut for `{{command_prefix}}impeccable delight`.

Invoke {{command_prefix}}impeccable delight, passing along any arguments provided here, and follow its instructions.
