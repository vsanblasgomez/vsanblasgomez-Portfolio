...
This is a pinned shortcut for `{{command_prefix}}impeccable optimize`.

Invoke {{command_prefix}}impeccable optimize, passing along any arguments provided here, and follow its instructions.
