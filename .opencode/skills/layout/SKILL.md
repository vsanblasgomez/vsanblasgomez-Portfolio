...
This is a pinned shortcut for `{{command_prefix}}impeccable layout`.

Invoke {{command_prefix}}impeccable layout, passing along any arguments provided here, and follow its instructions.
