...
This is a pinned shortcut for `{{command_prefix}}impeccable live`.

Invoke {{command_prefix}}impeccable live, passing along any arguments provided here, and follow its instructions.
