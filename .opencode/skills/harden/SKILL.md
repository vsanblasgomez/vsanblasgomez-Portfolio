...
This is a pinned shortcut for `{{command_prefix}}impeccable harden`.

Invoke {{command_prefix}}impeccable harden, passing along any arguments provided here, and follow its instructions.
