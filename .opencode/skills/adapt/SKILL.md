...
This is a pinned shortcut for `{{command_prefix}}impeccable adapt`.

Invoke {{command_prefix}}impeccable adapt, passing along any arguments provided here, and follow its instructions.
