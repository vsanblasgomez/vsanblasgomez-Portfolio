...
This is a pinned shortcut for `{{command_prefix}}impeccable animate`.

Invoke {{command_prefix}}impeccable animate, passing along any arguments provided here, and follow its instructions.
